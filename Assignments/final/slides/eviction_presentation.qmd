...
:::
- Modeling decisions are based on findings  
- **Baseline** → looks only at recent history.
- **Full** → incorporates neighborhood conditions.
- **Enhanced** → captures disparities, seasonality, and hotspot dynamics.
- **The Enhanced Model aligns most closely with how the city actually operates.**
